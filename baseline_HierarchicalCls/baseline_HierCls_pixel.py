...
def main(args):
    ...
    device = args.device
    train_data, train_labels = generate_data_label(mydata, 'train')
    test_data, test_labels = generate_data_label(mydata, 'test')
    ...
    rf = LogisticRegression(solver=args.solver, max_iter=10000, n_jobs=-1)
