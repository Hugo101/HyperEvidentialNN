                ...
                (loss_1_uce: {epoch_loss_1:.4f}, \
                    loss_2_entr:{epoch_loss_2:.4f}) \
                        loss_3_l2:{epoch_loss_3:.4f}) \
                            loss_4_entrDir:{epoch_loss_4:.4f}) \
                    acc: {acc:.4f}")
    ...
    with torch.no_grad():
        for batch_idx, (inputs, _, labels) in enumerate(dataloader):
            ...
            if uncertainty:
                ...
                loss_third = loss_third / singleton_size # l2 loss
                loss_fourth = loss_fourth / composite_size # entropy Dirichlet
            ...
            if exp_type in [101]:
                ...
                running_loss_3 += loss_third * singleton_size
                running_loss_4 += loss_fourth * composite_size
